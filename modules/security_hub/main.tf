...
locals {
  standards_subscription = {
    ...
    cis_aws_foundations_benchmark_v120 = var.standards_config != null ? merge(var.standards_config.cis_aws_foundations_benchmark_v120,
      {
        arn = "arn:aws:securityhub:${data.aws_region.current.name}::ruleset/cis-aws-foundations-benchmark/v/1.2.0"
    }) : null
    ...
    cis_aws_foundations_benchmark_v300 = var.standards_config != null ? merge(var.standards_config.cis_aws_foundations_benchmark_v300,
      {
        arn = "arn:aws:securityhub:${data.aws_region.current.name}::standards/cis-aws-foundations-benchmark/v/3.0.0"
    }) : null
